...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        hero: "url('/ass-static/images/hero-bg-pattern.png')",
        delivery: "url('/ass-static/images/delivery-international.jpg')",
        "v-circular": "url('/ass-static/images/vector-circular.svg')",

        "mode-alpha": "url('/ass-static/images/alpha-mode.jpg')",
        "mode-delivery": "url('/ass-static/images/delivery-mode.jpg')",
        "mode-quote": "url('/ass-static/images/quote-mode.jpg')",
        "mode-overseas": "url('/ass-static/images/overseas-mode.jpg')",
        "package-track": "url('/ass-static/images/banner-tracker.png')",
        "card-graphics": "url('/ass-static/images/card-bg.701e3783.svg')",
        "button-art": "url('/ass-static/images/bg.button-art.svg')",
